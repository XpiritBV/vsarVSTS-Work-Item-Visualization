...
$(function() { // on dom ready
    ...
    VSS.require([
                "VSS/Controls", "VSS/Controls/Common", "VSS/Controls/Menus",
                "Scripts/App/cy/MainMenu", "Scripts/App/cy/LegendMenu", "Scripts/App/cy/LegendGrid", "Scripts/App/cy/Storage",
                "Scripts/App/cy/WorkitemVisualizationGraph"
                //,"TFS/WorkItemTracking/Services", "VSS/Service", "TFS/WorkItemTracking/RestClient", "TFS/Core/RestClient", "TFS/VersionControl/GitRestClient", "TFS/VersionControl/TfvcRestClient", "TFS/WorkItemTracking/Contracts"
    ],
            function (Controls, Common, Menus, MainMenu, LegendMenu, LegendGrid, StorageLib, CyWorkitemVisualizationGraph
                //,Tfs_Wit_Service, VSS_Service, Tfs_Wit_Client, Tfs_Core_Client, Tfs_Git_Client, Tfs_Tfvc_Client, Tfs_Wit_Contracts
                ) {

                window.mainMenuView = Controls.Enhancement.enhance(MainMenu.ItemsView, $(".hub-view"), {});
                var legendMenuView = Controls.Enhancement.enhance(LegendMenu.ItemsView, $(".hub-view"), {});

                //var witClient = Tfs_Wit_Client.getClient();
                ////var coreClient = Tfs_Core_Client.getClient();
                //var gitClient = Tfs_Git_Client.getClient();
                //var tfvcClient = Tfs_Tfvc_Client.getClient();

                var Storage = new StorageLib.VsoStoreService();
                var graph = CyWorkitemVisualizationGraph.graph;// new WorkitemVisualizationGraph($("#cy"));
                graph.setExpandNodeCallback(expandNode);
                mainMenuView.setLoadWorkItemGraphCallback(loadInitialItem);
